...
import scalaID3.utils.EncodingHelper.TextEncodings.{Encoding, `ISO-8859-1`, `URF-16`, `UTF-16BE`, `UTF-8`}
...
object EncodingHelper {
  object TextEncodings extends Enumeration {
    ...
    val `URF-16`: Encoding     = Value("UTF-16")
  ...
  def standardCharset(encoding: Encoding): Charset =
    encoding match {
      ...
      case `URF-16`     => StandardCharsets.UTF_16
